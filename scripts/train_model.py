...
from src.models.malware_detector import MultiHeadMalwareDetector, MalwareDataset, train_multi_head_model
...
def train_model(
    ...
    console.print(f"[green]✅ Model initialized with {sum(p.numel() for p in model.parameters()):,} parameters[/green]")
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Train the multi-headed malware detection model"
    )
    parser.add_argument(
        "data_dir",
        type=Path,
